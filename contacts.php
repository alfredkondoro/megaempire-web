...
<head>
  ...
  <link rel="shortcut icon" href="assets/images/20200730-302-150x150.png" type="image/x-icon">
...
<section class="mbr-section form4 cid-s6bmIlbJof" id="form4-s">
    
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAEIpgj38KyLFELm2bK9Y7krBkz1K-cMq8&amp;q=place_id:ChIJ8dabFq5LXBgR3aGGoCZrD5Q" allowfullscreen=""></iframe></div>
            </div>
            <div class="col-md-6">
                ...
                <div>
                    ...
                    <div class="icon-contacts pb-3">
                        ...
                        <p class="mbr-text align-left mbr-fonts-style display-7"><strong>
                            Phone:</strong> +255 735 205 457<br><strong>
                            Email:</strong> info@megaempire.co.tz</p>
                    </div>
                </div>
                <div data-form-type="formoid">
                    <div data-form-alert="" hidden="">Thanks for filling out the form!</div>
                    <form class="block mbr-form" action="https://mobirise.com/" method="post" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="vOBtQWyQCJk2tm4/SGjUugHjDxzKmpKCUPZG60t6JNg5d6G2lgVktHZYNtBHGU1lfBDhsS0L5FmS+F6xyJ5kMYwupBjw4Gt5vWsh3/ZPM5O9quQN2H2zHrFXWo8QaabA">
                        <div class="row">
...
<section once="" class="cid-s6b0bp8uEz" id="footer6-i">
